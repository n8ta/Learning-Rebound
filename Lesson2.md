...
import rebound
```
## Accessing Rebound Methods to Create a Simulation
...
```
You don't need to use years AU and Msun but I like them because they keep our numbers small and managable. If you change your variables you will need to adjust you Universal Gravitational Constant (G) when generating initial conditions, get ready for some fun dimensional analyiss.
